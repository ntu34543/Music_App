...
import {BottomTabBar, BottomTabBarHeightCallbackContext, createBottomTabNavigator} from '@react-navigation/bottom-tabs';
  ...
  return (
    <NavigationContainer>
      <Tab.Navigator
        ...
        <Tab.Screen name="Frofile" component={Frofile} options={BottomTabBarHeightCallbackContext}/>
      </Tab.Navigator>
    </NavigationContainer>
  );
};
