          ...
          {musicList?.map(el => {
            return (
              <View style={styles.item}>
                ...
                <View style={styles.bgListartists}>
                  <View>
                    <Image style={styles.img} source={el?.nameSinger} />
                  </View>
                  <View>
                    <Text style={styles.playlistName}>{el?.nameSinger}</Text>
                    <Text style={styles.playlistSong}>{el?.nameSinger}</Text>
                  </View>
                  <Text style={styles.timeout}>{el?.nameSinger}</Text>
                  <TouchableOpacity android_ripple={{color: '#ffc618'}}>
                    <Image style={styles.img2} source={el?.nameSinger} />
                  </TouchableOpacity>
                </View>
              </View>
            );
