  ...
  const [artists, setArtists] = useState([
    {
      id: 0,
      name: 'Sugar',
      img: require('https://d26oc3sg82pgk3.cloudfront.net/files/media/edit/image/27773/original.jpg'),
      song: 'Made you look'
    },
    {
      id: 1,
  ...
  const [playlist, setPlaylist] = useState([
    {
      id: 0,
      name: 'Accu-check ',
      img1: require('https://d26oc3sg82pgk3.cloudfront.net/files/media/edit/image/27773/original.jpg'),
      img2: require('https://d26oc3sg82pgk3.cloudfront.net/files/media/edit/image/27773/original.jpg'),
  ...
  return (
    <View style={styles.container}>
      <View style={styles.banner}>
        <ImageBackground source={require("../../../assets/image/banner.jpg")} style={styles.image}>
      ...
      <View style={styles.allartists}>
        ...
        <ScrollView>
          <FlatList
            ...
            keyExtractor={item => item.name}
            renderItem={({ item }) => {
              return <View style={styles.bgListartists}>
                <View>
                  <Image
                    style={styles.img}
                    source={item.img1}
